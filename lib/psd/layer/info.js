...
(function() {
  var INFO_BYTES_8, LAYER_INFO, LazyExecute, Util,
  ...
  LAYER_INFO = {
    ...
    placedLayer: require('../layer_info/placed_layer'),
    linkedLayer: require('../layer_info/linked_layer'),
    smartObject: require('../layer_info/smart_object')
  };
      ...
      while (this.file.tell() < this.layerEnd) {
        ...
        for (name in LAYER_INFO) {
          ...
          if (this.externalFiles && key === 'lnk2') {
            this.externalFiles.push(i.parse());
            break;
          }
